    ...
    return (
        <nav className="navbar navbar-expand-lg navbar-light bg-light">
            <div className="container-fluid">
                <Link to={'/'} className={`navbar-brand ps-4 ${activeTab === '/' ? 'active' : ''}`} onClick={() => handleTabClick('/')}>
                    <img width="110" height="53" src="https://play-lh.googleusercontent.com/lAFgx9P9v6g9CGiJ4yXEghRTGikQg88xuxOg30t_licriW4ODAyXVK4NHBJj-HGILw=w240-h480-rw" className="img-fluid" alt="Guvi-blog-logo" />
                </Link>
